      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
          {reviews.map((rev) => (
            <div
              key={rev.id}
              className="p-8 rounded-2xl bg-[#FFFFFF] border border-[#E8DED6] relative flex flex-col justify-between hover:border-[#B85C38]/50 transition-colors shadow-sm"
            >
              <div className="absolute top-6 right-6 text-[#B85C38]/20">
                <Quote size={36} />
              </div>
              ...
              <div className="mt-6 pt-4 border-t border-[#E8DED6]/40 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <span className="text-[11px] text-[#6F6761] flex items-center gap-1">
                      <CheckCircle2 size={12} className="text-[#4E8A57]" /> Verified Diner
                    </span>
                  </div>
                </div>

                <span className="text-xs text-[#6F6761]">{rev.date}</span>
              </div>
            </div>
          ))}
        </div>
