export const restaurantInfo = {
  ...
  openingHours: {
    monday_thursday: "12:00 PM - 01:00 AM",
    friday: "02:00 PM - 02:00 AM",
    saturday_sunday: "12:00 PM - 02:00 AM"
  },
  stats: {
    rating: 4.9,
    totalReviews: "3,800+",
  ...
  features: [
    {
      ...
      description: 'Traditional Pakistani secret spice blends slow-roasted over real charcoal.'
    },
    {
      id: 'quality',
      icon: 'ShieldCheck',
      title: 'Quality Ingredients',
      description: '100% fresh, organic Halal meat handpicked daily and prepared to perfection.'
    },
    {
      id: 'dining',
      icon: 'UtensilsCrossed',
      title: 'Memorable Dining',
      description: 'Warm ambiance, live flame grill showcase, and traditional Dastarkhwan seating.'
    },
    {
      id: 'ordering',
      icon: 'Bike',
      title: 'Convenient Ordering',
      description: 'Ultra-fast home delivery across Peshawar, takeaway pickup, and easy table reservations.'
    }
  ],
  story: {
  ...
  socialLinks: {
    ...
    instagram: "https://instagram.com/threeflamesrestaurant",
    tiktok: "https://tiktok.com/@threeflamesrestaurant",
    youtube: "https://youtube.com/@threeflames"
  }
};
